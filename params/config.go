...
var (
	MainnetGenesisHash = common.HexToHash("0x226d9265fce691f32f153303cd9f497d0944396c99f290a0fc34b2f19327d259")
...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		// RedCoastBlock:       big.NewInt(200),
		// BerlinBlock:         big.NewInt(400),
		// LondonBlock:         big.NewInt(400),
		// SophonBlock:         big.NewInt(400),
		// StormBlock:			 big.NewInt(400),
		// RedCoastBlock:       big.NewInt(5165400),
		RedCoastBlock:       big.NewInt(5192000),
		BerlinBlock:         big.NewInt(18935000),
		LondonBlock:         big.NewInt(18935000),
		SophonBlock:         big.NewInt(18935000),
		StormBlock:			 big.NewInt(18935000),
	...
	AllEthashProtocolChanges = 		&ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, big.NewInt(0), new(EthashConfig), nil, nil}
	...
	AllCongressProtocolChanges = 	&ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, &CongressConfig{Period: 0, Epoch: 30000}}

	TestChainConfig =	 			&ChainConfig{big.NewInt(1),    big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, new(EthashConfig), nil, nil}
...
type ChainConfig struct {
	...
	StormBlock 	  *big.Int `json:"stormBlock,omitempty"`
	// StromBlock 	  *big.Int `json:"stromBlock,omitempty"`
...
func (c *ChainConfig) String() string {
	...
	return fmt.Sprintf("{ChainID: %v Homestead: %v DAO: %v DAOSupport: %v EIP150: %v EIP155: %v EIP158: %v Byzantium: %v Constantinople: %v Petersburg: %v Istanbul: %v, Muir Glacier: %v, RedCoastBlock: %v, Berlin: %v, London: %v, Sophon: %v, Strom: %v, Engine: %v}",
		c.ChainID,
		c.HomesteadBlock,
		c.DAOForkBlock,
		c.DAOForkSupport,
...
func (c *ChainConfig) IsStorm(num *big.Int) bool {
	return isForked(c.StormBlock, num)
}
...
func (c *ChainConfig) CheckConfigForkOrder() error {
	...
	for _, cur := range []fork{
		...
		{name: "stormBlock", block: c.StormBlock},
	} {
		if lastFork.name != "" {
	...
	// 	{name: "stromBlock", block: c.StromBlock},
	// 	// {name: "stromBlock", block: c.StromBlock},
	// } {
	...
	// 		fmt.Println(lastFork.block)
	// 		fmt.Println(cur.name)
	// 		fmt.Println(cur.block)
	// 		if lastFork.block == nil && cur.block != nil {
	// 			fmt.Println("3")
	// 			return fmt.Errorf("unsupported fork ordering: %v not enabled, but %v enabled at %v",
	// 				lastFork.name, cur.name, cur.block)
...
func (c *ChainConfig) checkCompatible(newcfg *ChainConfig, head *big.Int) *ConfigCompatError {
	...
	if isForkIncompatible(c.StormBlock, newcfg.StormBlock,head ){
		return newCompatError("StormBlock fork block", c.StormBlock, newcfg.StormBlock)
	}
